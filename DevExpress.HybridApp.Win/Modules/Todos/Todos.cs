...
namespace DevExpress.DevAV.Modules {
    public partial class Todos : BaseModuleControl {
        public Todos()
        ...
        protected override void OnInitServices(Mvvm.IServiceContainer serviceContainer) {
            ...
            serviceContainer.RegisterService(new FlyoutDetailFormDocumentManagerService(ModuleType.EditTodo));
        }
        void UpdateData() {
        ...
        void PrintButtonClick() {
            ...
            main.SelectModule(ModuleType.TodoPrint, (x) =>
            {
        ...
        void collapseButton_Click(object sender, EventArgs e) {
            if(tileControlLCI.Visibility == XtraLayout.Utils.LayoutVisibility.Always) {
                ...
                tasksSLI.Padding = new XtraLayout.Utils.Padding(buttonHide.Width, 2, 10, 10);
                return;
            }
            if(tileControlLCI.Visibility == XtraLayout.Utils.LayoutVisibility.Never) {
                ...
                tasksSLI.Padding = new XtraLayout.Utils.Padding(2, 2, 10, 10);
                return;
            }
        }
