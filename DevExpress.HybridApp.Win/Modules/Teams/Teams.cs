...
namespace DevExpress.DevAV.Modules {
    public partial class Teams : BaseModuleControl {
        ...
        public EmployeeTaskCollectionViewModel TasksViewModel {
            get { return TryGetModuleViewModel<EmployeeTaskCollectionViewModel>(ref tasksViewModel, ModuleType.Todos); }
        }
        ...
        void mailMergeClick(object sender, EventArgs e) {
            prevFocusedRow = GetSelectedIndex();
            GotoModule(ModuleType.MemberMailMerge, GetSelectedEmployee());
        }
        ...
        void ShowEditEmployee(Employee employee) {
            ...
            main.SelectModule(ModuleType.MemberEdit, (x) =>
            {
                if(employee != null) {
        ...
        void simpleLabelItem1_MouseDown(object sender, MouseEventArgs e) {
            if(tileControlLayoutItem.Visibility == XtraLayout.Utils.LayoutVisibility.Always) {
                ...
                simpleLabelItem2.Padding = new XtraLayout.Utils.Padding(buttonHide.Width + tileView1.OptionsTiles.Padding.Left, 2, 10, 10);
                return;
            }
            if(tileControlLayoutItem.Visibility == XtraLayout.Utils.LayoutVisibility.Never) {
                ...
                simpleLabelItem2.Padding = new XtraLayout.Utils.Padding(2, 2, 10, 10);
                return;
            }
        }
        ...
        void printEmployeeProfileItem_Click(object sender, EventArgs e) {
            GotoModule(ModuleType.TeamsPrint, EmployeeReportType.Profile);
        }
        void printEmployeeDirectoryItem_Click(object sender, EventArgs e) {
            GotoModule(ModuleType.TeamsPrint, EmployeeReportType.Directory);
        }
        void printEmployeeListItem_Click(object sender, EventArgs e) {
            GotoModule(ModuleType.TeamsPrint, EmployeeReportType.Summary);
        }
