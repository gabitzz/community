namespace DevExpress.DevAV.ViewModels {
    ...
    partial class CustomerCollectionViewModel {
        ...
        public override void Delete(Customer entity) {
            MessageBoxService.ShowMessage("To ensure data integrity, the Customers module doesn't allow records to be deleted. Record deletion is supported by the Teams module.", "Delete Customer", MessageButton.OK);
        }
    }
}
