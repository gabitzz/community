namespace DevExpress.DevAV.ViewModels {
    ...
    partial class QuoteCollectionViewModel {
        ...
        public override void Delete(Quote entity) {
            MessageBoxService.ShowMessage("To ensure data integrity, the Opportunities module doesn't allow records to be deleted. Record deletion is supported by the Teams module.", "Delete Opportunity", MessageButton.OK);
        }
    }
