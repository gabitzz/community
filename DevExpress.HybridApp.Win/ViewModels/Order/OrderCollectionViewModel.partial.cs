...
namespace DevExpress.DevAV.ViewModels {
    partial class OrderCollectionViewModel {
        ...
        public override void Delete(Order entity) {
            MessageBoxService.ShowMessage("To ensure data integrity, the Sales module doesn't allow records to be deleted. Record deletion is supported by the Teams module.", "Delete Sale", MessageButton.OK);
        }
    }
